 ...
 */
public final class MutinyMultiCharSequence extends AbstractMulti<Integer> {

    final CharSequence string;

    public MutinyMultiCharSequence(CharSequence string) {
        this.string = string;
    }

    @Override
    public void subscribe(MultiSubscriber<? super Integer> s) {
