 ...
 * @author José
 */
public class StreamExAmaembo extends ShakespearePlaysScrabble {
    ...
    public List<Entry<Integer, List<String>>> measureThroughput() {
        ...
        Function<String, Map<Integer, Long>> histoOfLetters =
                word -> IntStreamEx.ofChars(word).boxed()
                            .collect(
        ...
        Function<String, Long> nBlanks =
                word -> StreamEx.of(histoOfLetters.apply(word)
                            .entrySet())
                            .mapToLong(blank)
                            .sum();
        ...
        Function<String, IntStreamEx> first3 = word -> IntStreamEx.ofChars(word).limit(3);
        Function<String, IntStreamEx> last3 = word -> IntStreamEx.ofChars(word).skip(Integer.max(0, word.length() - 4));

        // Stream to be maxed
        Function<String, IntStreamEx> toBeMaxed =
            word -> StreamEx.of(first3.apply(word), last3.apply(word))
...
//        System.out.println(finalList) ;
    ...
    public static void main(String[] args) throws Exception {
        StreamExAmaembo s = new StreamExAmaembo();
        s.init();
